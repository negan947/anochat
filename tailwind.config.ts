  ...
  theme: {
    extend: {
      colors: {
        ...
        // Accent colors for anonymous interactions
        phantom: {
          50: '#fdf4ff',
          100: '#fae8ff',
          200: '#f5d0fe',
        ...
        // Encrypted/secure action colors
        secure: {
          50: '#ecfdf5',
          100: '#d1fae5',
          200: '#a7f3d0',
        ...
        // Standard semantic colors with anonymous twist
      ...
      keyframes: {
        ...
        skeleton: {
          '0%': { backgroundColor: 'rgba(55, 65, 81, 0.3)' },
          '100%': { backgroundColor: 'rgba(75, 85, 99, 0.6)' },
        },
      },
      spacing: {
        '18': '4.5rem',
